...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-100 transition-colors dark:bg-zinc-100 dark:text-zinc-900 bg-zinc-900 text-zinc-100">
      {/* App container */}
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <input
            ...
            className="w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:bg-zinc-100 dark:text-zinc-900"
          />
